...
config :phoenix_fund, PhoenixFundWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "KA3b1bzq3GsWZXaMM7lAIjkH8rZdUuXqEoOI8pbKGLHN21rcvlrXeBhSNtAGdLYW",
  watchers: [
...
config :phoenix_fund, PhoenixFundWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phoenix_fund_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :phoenix_fund, dev_routes: true
